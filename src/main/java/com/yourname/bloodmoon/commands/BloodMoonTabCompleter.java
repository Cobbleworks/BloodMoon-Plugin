...
public final class BloodMoonTabCompleter implements TabCompleter {
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String alias, String[] args) {
        ...
        if (args.length == 2 && "spawn".equals(sub)) {
            return filter(List.of("vampire", "clown", "zombie", "witch"), args[1]);
        }
        if (args.length == 3 && "spawn".equals(sub)
            && ("vampire".equals(args[1].toLowerCase()) || "clown".equals(args[1].toLowerCase()) || "zombie".equals(args[1].toLowerCase()) || "witch".equals(args[1].toLowerCase()))) {
